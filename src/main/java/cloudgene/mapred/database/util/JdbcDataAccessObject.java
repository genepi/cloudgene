...
public abstract class JdbcDataAccessObject {
	...
	public Object queryForObject(String sql, Object[] params, IRowMapper mapper)
			throws SQLException {
		return runner.query(getConnection(), sql, new ObjectHandler(mapper),
				params);
	}
	...
	public List query(String sql, Object[] params, IRowMapper mapper)
			throws SQLException {
		return (List) runner.query(getConnection(), sql,
				new ListHandler(mapper), params);
	}
	...
	public Map queryForMap(String sql, IRowMapMapper mapper)
			throws SQLException {
		return (Map) runner.query(getConnection(), sql, new MapHandler(mapper));
	}
	...
	public List query(String sql, IRowMapper mapper) throws SQLException {
		return (List) runner.query(getConnection(), sql,
				new ListHandler(mapper));
	}

	public int update(String sql, Object[] params) throws SQLException {
		return runner.update(getConnection(), sql.toString(), params);
	}

	public int update(String sql) throws SQLException {
		return runner.update(getConnection(), sql.toString());
	}
	...
	public List<Integer> batchGeneratedKeys(String sql, Object[][] params)
		...
		return runner.insertBatch(getConnection(), sql, handler, params);
	}
